...
def test_missing_sub_mission_validation():
    ...
    try:
        ...
        print("📁 Created mission with 2/3 sub-missions validated")
        print("🔍 Running validation (should fail)...")
...
def test_sub_mission_failed():
    ...
    try:
        ...
        print("📁 Created mission with 1 FAILED sub-mission")
        print("🔍 Running validation (should fail)...")
...
def test_forbidden_paths_violation():
    ...
    try:
        ...
        print("📁 Created mission with forbidden path violation")
        print("🔍 Running validation (should fail)...")
...
def test_blocked_sub_mission():
    ...
    try:
        ...
        print("📁 Created mission with 1 BLOCKED sub-mission")
        print("🔍 Running validation (should fail)...")
